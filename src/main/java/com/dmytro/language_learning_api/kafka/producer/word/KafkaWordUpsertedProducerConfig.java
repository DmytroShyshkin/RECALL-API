...
@Configuration
public class KafkaWordUpsertedProducerConfig {
    ...
    @Bean("wordUpsertedProducerFactory")
    public ProducerFactory<String, WordUpsertedEvent> producerFactory() {
    ...
    @Bean("wordUpsertedKafkaTemplate")
    public KafkaTemplate<String, WordUpsertedEvent> kafkaTemplate() {
